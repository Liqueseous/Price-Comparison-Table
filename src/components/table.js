...
//then npm run
//this will execute a development build on your local system. If you want to publish the app to a web host instead of running npm 
//start type in npm build and that will build a production version of the app.
